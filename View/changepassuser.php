...
if(isset($_POST['update']))
{
  ...
  $result = mysqli_query($conn, "select user.password from user WHERE id = $id");
     $user = mysqli_fetch_assoc($result);
          ...
          echo ("<SCRIPT LANGUAGE='JavaScript'>
    window.alert('Password Update Not Successful...')
...
<html>
<head>
  <title>Change Password | Much Ado About Books</title>
  <!-- Icons font CSS-->
        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form id = "registration" action="changepassuser.php" method="POST">
