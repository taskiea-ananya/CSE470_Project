    ...
    <div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title">Register a Book:</h2>
                    <form action="process/addempprocess.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="series" placeholder="Series" name="series" required="required">
                        </div>
                        <p>First Published</p>
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <input class="input--style-1" type="date" placeholder="First Published" name="firstPublished" required="required">
                                   
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <input class="input--style-1" type="text" placeholder="Publisher Name" name="publisherName" required="required">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="number" placeholder="ISBN" name="isbn" required="required" >
                        </div>

                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Language" name="language" required="required">
                        </div>

                        
                         <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Format" name="format" required="required">
                        </div>

                        <div class="input-group">
                            <input class="input--style-1" type="number" placeholder="Total Pages" name="totalpages" required="required">
                        </div>

                        <div class="input-group">
                            <input class="input--style-1" type="number" placeholder="GoodReads Rating" name="goodreadsrating" required="required">
                        </div>
